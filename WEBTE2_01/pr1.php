...
<body>
    <?php
        ...
        foreach($subory as $subor) {
            ...
            if(is_dir($dir.$subor)) {
                if($subor == "..") {
                    echo "<td><a href='index.php'>" .  $subor. "/". "</a></td><td></td><td></td></tr>";
                    continue;
                }
                echo "<td><a href='pr2.php'>" .  $subor. "/". "</a></td><td></td><td></td></tr>";
                continue;
            }
            else {
                echo "<td>" .  $subor . "</td>";
    ...
    <form action="upload.php" method="post" enctype="multipart/form-data">
        <input type="text" name="path" id="path" value="files/pr1/" hidden>
